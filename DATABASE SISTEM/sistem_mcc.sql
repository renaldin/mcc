...
--
-- Host: localhost:3306
-- Generation Time: Apr 24, 2025 at 02:10 PM
...
CREATE TABLE `cs_treatments` (
  ...
  `judgement` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE `schedules` (
  `id` bigint UNSIGNED NOT NULL,
  `tank_name` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
...
INSERT INTO `users` (`id`, `name`, `email`, `phone`, `password`, `created_at`, `updated_at`, `role`) VALUES
(1, 'Admin', 'admin@gmail.com', '088221655019', '$2y$12$D7QlRXckGIHLmFnKGBWiv./kVns6D3Ih7a3M1P/zx.kpHEASuNmdy', '2024-11-27 19:59:15', '2024-11-27 19:59:15', 'admin'),
(2, 'wangi', 'wangi@gmail.com', '', '$2y$12$0AezsH1CUnRLvWT9l6VoVeMSZajy1N3X0bdp/m5lC/qC5e0VbYUZS', '2024-11-28 01:15:18', '2024-11-28 01:15:18', 'admin'),
(3, 'kana', 'kana@gmail.com', '', 'hash', NULL, NULL, 'maintenance');
