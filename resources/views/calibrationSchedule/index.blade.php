    ...
    <div class="container-fluid">
        <div class="card">
            <div class="card-header">
                <a href="{{ route('tambah-jadwal-kalibrasi') }}" class="btn btn-primary float-right"
                    style="margin-right: 5px;"> Tambah Data</a>
                <a href="{{ route('kalender-jadwal-kalibrasi') }}" class="btn btn-primary float-right"
                        ...
                        @foreach ($calibrationScheduleList as $item)
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a href="/detail-jadwal-kalibrasi/{{ $item->id }}"
